      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-20">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display text-[clamp(2.2rem,4.4vw,3.8rem)] leading-[1.04] tracking-[-0.012em] text-graphite">
              Hand-built lighting,{" "}
              <span className="text-iridescent">signed and numbered.</span>
            </h2>
          </div>
          <div className="lg:col-span-6 lg:col-start-7 lg:pt-2">
            <p className="max-w-[580px] text-[17px] leading-[1.78] text-graphite/70 md:text-[18px]">
              Arvex is a small atelier of craftspeople, working from a converted
              warehouse in Jaipur. We draw on the city's long traditions of crystal,
            ...
            <div className="mt-14 grid grid-cols-2 gap-x-12 gap-y-10 font-mono text-[10px] uppercase tracking-[0.32em] text-graphite/55">
        ...
        <div className="mt-28 grid grid-cols-1 gap-px bg-champagne-200/60 md:grid-cols-2 lg:grid-cols-4 md:mt-32">
          {CATEGORIES.map((c, i) => (
            ...
            >
              ...
              <span className="mt-8 flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.28em] text-graphite/55 transition-colors group-hover:text-graphite">
