...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3 md:bottom-8 md:right-8 lg:bottom-10 lg:right-10 safe-bottom">
      {/* Instagram Button */}
      <motion.a
        href={igUrl}
        target="_blank"
        ...
        className="group flex items-center gap-3 rounded-full bg-white/70 pl-4 pr-5 py-3 shadow-editorial backdrop-blur-md ring-1 ring-champagne-300/40 transition-all duration-500 hover:bg-white/90 hover:shadow-glass-hover hover:scale-[1.02]"
      >
